import { sortNumeric, sortLocalCompare, sortTrustScore } from "lib/helpers/sortIdHelpers";
import { SortDirection, BaseDataType, SortFieldById } from "lib/types/market-data-table/types";
