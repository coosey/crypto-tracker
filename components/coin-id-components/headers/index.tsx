import { DataTHProps } from 'lib/types/market-data-table';
import { SortFieldEnumById } from 'lib/types/market-data-table/enums';
import { SortFieldById } from 'lib/types/market-data-table/types';
